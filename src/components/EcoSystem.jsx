        ...
        <div className="relative w-full max-w-[1920px] mx-auto">
          ...
          <div className="absolute top-[2919px] left-[50%] -translate-x-[50%] w-[1600px] max-w-[95vw]">
            ...
            <img
              src={image13}
              alt="Card 13"
              className="absolute top-[103px] left-0 opacity-100 
                         w-[35vw] max-w-[723px] h-auto 
                         animate-[jump_0.8s_ease-in-out_infinite]"
            />
            ...
            <img
              src={image10}
              alt="Card 10"
              className="absolute top-[290px] left-[573px] opacity-100 
                         w-[18vw] max-w-[374px] h-auto"
            />
            ...
            <img
              src={image11}
              alt="Card 11"
              className="absolute top-0 left-[869px] opacity-100 
                         w-[22vw] max-w-[450px] h-auto"
            />
            ...
            <img
              src={image12}
              alt="Card 12"
              className="absolute top-[364px] left-[1226px] opacity-100 
                         w-[18vw] max-w-[374px] h-auto"
            />
          </div>
        </div>
