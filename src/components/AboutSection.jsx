    ...
    <div className="relative w-full h-auto">
      ...
      <div className="block md:hidden relative">
        ...
        <img
          ...
          className="absolute top-1/2 left-0 w-full h-auto object-cover"
        />
      </div>
      ...
      <div className="about-section-para absolute left-[800px] top-[325px] w-[560px] h-[510px] p-3 font-inter font-medium text-black text-[25px] leading-[1.4] rotate-[-7.5deg] opacity-100 hidden md:block">
        <p>
          ...
          three key pillars: Mek’s Shield, an AI-driven defense against scams
          and MEV; Mek’s Vault, a staking fortress offering high APY; and Mek’s
          War Room, a precision meme coin signal hub to help investors stay
          ahead. 
          <br/>
          <br/>
          
          No villains, no drama only heroes, loot, and glory. Grab your
          $CMEK and join the revolution to conquer the memecoin universe!k
        </p>
      </div>
    </div>
  );
