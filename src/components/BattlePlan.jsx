...
//                    text-center tracking-wide mt-39"
//         >
//           BATTLE PLAN
//         </h2>
...
//             )
//           }
//           className="md:hidden mt-5 w-[349px] h-[66px] bg-[#1E1E4F] border-[4px] border-[#506EFF] text-white
...
//             )
//           }
//           className="hidden md:flex absolute w-[1079px] h-[96px] bottom-20 left-1/2 transform -translate-x-1/2 bg-[#1E1E4F] border-[10px] border-[#506EFF] text-white
...
function BattlePlan() {
  ...
  return (
    // <div
    //   className="relative max-w-[1920px] mx-auto min-h-screen bg-cover bg-center bg-no-repeat
    //              py-10 px-4 overflow-hidden opacity-100 mt-[-100px] md:mt-[-200px] xl:top-[300px] xl:h-[1200px]"
    //   style={{ backgroundImage: `url(${battle})` }}
    // >
    ...
    mt-[-50px] md:mt-[-150px] xl:mt-[-200px] xl:h-[1200px]
  "
      style={{ backgroundImage: `url(${battle})` }}
    >
